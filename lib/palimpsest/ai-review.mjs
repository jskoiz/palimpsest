...
/**
 * A clean containment or placement miss gets one corrective generation.
 * Fidelity, blending, or source-preservation failures stop immediately rather
 * than spending another image pass.
 * @param {{
 *   contained: boolean,
 *   faithful: boolean,
