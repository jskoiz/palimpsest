...
export function buildOpenAiEditPrompt(change, hasReference = false) {
  return [
    ...
    hasReference
      ? "Image 2 is a positioned transparent visual reference. Preserve its primary subject's identity, silhouette, geometry, proportions, symbols, labels, and fine construction details while regenerating it inside the editable area."
      : "",
    hasReference
      ? "Match Image 2's center and relative scale. Keep the complete referenced subject inside the editable area with clear surrounding space; never paste Image 2's pixels or rectangular background directly."
      : "",
    hasReference
