...
export function buildOpenAiEditPrompt(
  ...
  return [
    ...
    hasReference
      ? "Match the reference preview's scale and center exactly inside the transparent placement footprint. Keep the complete subject centered with clear space on all four sides without shrinking it below half of the footprint's width or height. The surrounding opaque mask is protected prior artwork, not extra room for the subject."
