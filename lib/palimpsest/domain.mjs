...
export function buildOpenAiEditPrompt(
  ...
  return [
    ...
    hasReference
      ? "Image 1 already contains a prepared composition guide at the intended position and maximum size. Image 2 is the contributor's full-resolution visual reference. Use Image 2 as the identity and detail source while keeping the primary subject within the guide footprint in Image 1; do not enlarge, crop, reposition, redesign, simplify, or substitute it."
      : "",
    hasReference
    ...
    hasReference
      ? "Preserve every visible component of the primary referenced subject and do not invent hidden structure or replacement controls. Reference backgrounds, display stands, or secondary props may be omitted unless the requested change explicitly includes them."
    ...
    hasReference
      ? "Keep the prepared composition guide centered inside the transparent editable area with clear space on all four sides. If the reference framing is tight, preserve the complete visible primary subject within the guide rather than inventing missing parts or cropping it further."
      : "If a new subject approaches the editable edge, scale it down instead of cropping it.",
    hasReference && containmentRetry
      ? "This is the single containment retry. The previous candidate crossed the safe area. Render the complete primary subject centered at no more than 70% of the prepared guide's width and height. Leave the rest of the guide and the larger editable area visibly clear; do not enlarge the subject to fill either one."
      : "",
